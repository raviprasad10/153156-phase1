...
public class WalletTest {
	...
	public void initData() {
		...
		cust1 = new Customer("Amit", "9900112212", new Wallet(new BigDecimal(
				9000)));
		cust2 = new Customer("Ajay", "9963242422", new Wallet(new BigDecimal(
				6000)));
		cust3 = new Customer("Yogini", "9922950519", new Wallet(new BigDecimal(
				7000)));
	...
	public void testCreateAccount1() {
		...
		cust = service
				.createAccount("Amit", "9900112213", new BigDecimal(7000));
	...
	public void testShowBalance2() {
		...
		assertEquals(cust.getWallet().getBalance(), cust3);
	...
	public void testFundTransfer2() {
		cust1 = service.fundTransfer("9900112212", "9963242422",
				new BigDecimal(2000));
	...
	public void TestValidate() {
		Customer customer = new Customer("Ravi", "8121101096", new Wallet(
				new BigDecimal(10)));
		((WalletServiceImpl) service).acceptDetails("Ravi", "8121101096",
				new BigDecimal(10));
	}
